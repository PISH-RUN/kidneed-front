...
export const SubscriptionCard = ({ subscription, index = 0, onSelect }: any) => {
  const finalPrice = new Intl.NumberFormat().format((subscription?.discountPrice >= 0 ? subscription?.discountPrice : subscription?.currentPrice) / 10);
        ...
        <div className="tw-flex tw-flex-col">
          ...
          <div className="tw-flex tw-items-center">
            ...
            <div className="tw-flex tw-items-center tw-mr-4">
              ...
              >
                {finalPrice === "0" ? "رایگان" : finalPrice + " تومان"}
              </div>
            </div>
          </div>
        </div>
