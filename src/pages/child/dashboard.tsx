    ...
    <BaseLayout>
      <>
        <Box sx={styles.root}>
          ...
          <UserSelect
            open={showUserSelect}
            onSelect={() => setShowUseSelect(false)}
          />
          <Box
            component="img"
            src="/images/logo.png"
...
const Clock = () => {
  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" sx={{ color: "#8CA3A5" }}>
        19 اسفند
      </Typography>
          ...
          {Array.from({ length: 3 })
            ...
            .map((_, i) => (
              ...
              >
                ...
                {i === 2 && <Typography variant="h4">{20}</Typography>}
              </Box>
            ))}
        </Box>
    ...
    >
      <Box>
        ...
        <Typography variant="h6">
          برای ورود به بخظ والدین، ابتدا لطفا پاسخ سوال زیر را وارد نمایید.
        </Typography>
        <Box
          sx={{
            background: "#fff",
        ...
        >
          ...
          <Stack
            ...
            sx={{
              width: "100%",
              "& button": { flexGrow: 1, borderRadius: 5 },
              mt: 4,
            }}
          >
            ...
            <Button
              variant="outlined"
              size="large"
              sx={{ borderColor: "#D9D9D9", color: "rgba(0, 0, 0, 0.65)" }}
              onClick={onClose}
            >
              لغو
            </Button>
    ...
    >
      <Box sx={{ width: 460, textAlign: "center" }}>
        <Box
          ...
          src="/images/logo.png"
          alt="logo"
          sx={{ width: 260, maxWidth: 260, mx: "auto", mb: 1 }}
        />
